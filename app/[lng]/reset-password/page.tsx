        ...
        <div className="text-center mb-8">
          <Link href={`/${lng}`} className="inline-flex items-center gap-2.5 no-underline">
            <svg width="40" height="40" viewBox="0 0 32 32" fill="none">
              <rect width="32" height="32" rx="8" fill="url(#newpw-logo-grad)" />
              ...
              <defs><linearGradient id="newpw-logo-grad" x1="0" y1="0" x2="32" y2="32"><stop stopColor="#4f46e5" /><stop offset="1" stopColor="#6366f1" /></linearGradient></defs>
            </svg>
